...
func LoadConfigOptional(configFile string, optional bool) (*Config, error) {
	...
	if err != nil {
		if optional {
			if os.IsNotExist(err) || errors.Is(err, syscall.EISDIR) {
				...
				cfg := &Config{CredentialInFlight: DefaultCredentialInFlightConfig(), Codex: CodexConfig{WeeklyOverdraft: DefaultCodexWeeklyOverdraftConfig()}}
	...
	if errValidate := validateCredentialWeightYAML(data); errValidate != nil {
		if optional {
			cfgOptional := &Config{CredentialInFlight: DefaultCredentialInFlightConfig(), Codex: CodexConfig{WeeklyOverdraft: DefaultCodexWeeklyOverdraftConfig()}}
