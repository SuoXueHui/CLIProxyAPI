...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/codex-overdraft/config", s.mgmt.GetCodexOverdraftConfig)
		mgmt.PUT("/codex-overdraft/config", s.mgmt.PutCodexOverdraftConfig)
		mgmt.POST("/codex-overdraft/probe", s.mgmt.PostCodexOverdraftProbe)
		mgmt.POST("/codex-overdraft/gate", s.mgmt.PostCodexOverdraftGate)
		...
		mgmt.GET("/codex/quota", s.mgmt.GetCodexQuotaUsage)
		...
		mgmt.POST("/usage-queue/claim", s.mgmt.ClaimUsageQueue)
		mgmt.POST("/usage-queue/ack", s.mgmt.AckUsageQueue)
		mgmt.GET("/usage-queue/status", s.mgmt.GetUsageQueueStatus)
