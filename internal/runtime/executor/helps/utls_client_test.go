...
func TestNewUtlsHTTPClientReusesChromeTransportForSameScope(t *testing.T) {
	...
	if firstFallback.chrome != secondFallback.chrome {
		t.Fatal("Chrome protected-host transport was not reused")
	}
}
